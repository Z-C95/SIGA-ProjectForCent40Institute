...
ALLOWED_HOSTS = env.list("ALLOWED_HOSTS", default=['.vercel.app', '.now.sh', 'localhost', '127.0.0.1'])
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles_build' / 'static'  # ← CAMBIAR
...
# Dominios de confianza para Vercel
